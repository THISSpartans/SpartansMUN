      ...
      <main>
        ...
        <Fade cascade><div className={styles.cont}>
          <div className={styles.box} id={styles.A1}>
            ...
            <p>If you have any additional questions, check out the <a href="/faq">FAQ page</a>, and if your question still isn't answered, contact us at <a className={styles.link} href="mailto:thismun@126.com">thismun@126.com</a>. We hope to see you at the first THISMUN!</p>
